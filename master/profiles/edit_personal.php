...
<option value="1" <?php if (!(strcmp(1, $row_rsEdit['bestfeature']))) {echo "selected=\"selected\"";} ?>>eyes</option>
      ...
      <tr>
        ...
        <td valign="top"><textarea id="fivethings" rows="3" cols="45" name="fivethings"><?php echo $row_rsEdit['fivethings']; ?></textarea></td>
      </tr>
      <tr>
        <td valign="top" align="right">In my bedroom you will find:</td>
        <td valign="top"><textarea id="bedroomthings" rows="3" cols="45" name="bedroomthings"><?php echo $row_rsEdit['bedroomthings']; ?></textarea></td>
      </tr>
      <tr>
