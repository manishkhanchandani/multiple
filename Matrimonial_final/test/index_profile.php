...
<?php if ($totalRows_rsStatus == 0) { // Show if recordset empty ?>
  ...
  <?php } // Show if recordset empty ?><p><a href="matrimony_edtgeneral.php">General Profile</a></p>
<p><a href="matrimony_edtprofessional.php">Professional</a></p>
<p><a href="matrimony_edtpersonal.php">Personal</a></p>
<p><a href="matrimony_social.php">Social</a></p>
<p><a href="matrimony_edtcontact.php">Contacts</a></p>
</body>
</html>
<?php
