...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	if(!trim($_POST['description']) || strlen($_POST['description'])<100) {
		unset($_POST["MM_insert"]);
		$message .= "Please enter the description. Description should be more than 100 characters.";
	}
}
?>
<?php
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO confession_descr (user_id, title, description, post_date, category_id) VALUES (%s, %s, %s, %s, %s)",
...
<!-- InstanceBeginEditable name="EditRegion3" -->
		  <div class="post">
            <h1 class="title"><a href="#">Add Confession</a></h1>
...
do {  
?>
        <option value="<?php echo $row_rsCat['category_id']?>"><?php echo $row_rsCat['category']?></option>
        <?php
...
?>
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="title" value="<?php echo $_POST['title']; ?>" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right" valign="top">Description:</td>
      <td><textarea name="description" cols="32" rows="7"><?php echo $_POST['description']; ?></textarea>      </td>
    </tr>
    <tr valign="baseline">
