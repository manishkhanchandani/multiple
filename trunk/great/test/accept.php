...
if($totalRows_rsAccept==1) {
	...
	$sql = "insert into matrimony_accept set user_id = '".$_SESSION['user_id']."', proposer_id = '".$_GET['proposer_id']."'";
	@mysql_query($sql);
	$sql = "insert into matrimony_accept set user_id = '".$_GET['proposer_id']."', proposer_id = '".$_SESSION['user_id']."'";
	@mysql_query($sql);
	$message = "User successfully added in your Proposer list.";
}
