...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  ...
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><textarea name="Identification" cols="50" rows="5"><?php echo $row_Recordset15['Identification']; ?></textarea>      </td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><textarea name="Allergy" cols="50" rows="5"><?php echo $row_Recordset15['Allergy']; ?></textarea>      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right" valign="top"><span class="style1">Disease:</span></td>
      <td><textarea name="Disease" cols="50" rows="5"><?php echo $row_Recordset15['Disease']; ?></textarea>      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right" valign="top"><span class="style1">Disablility:</span></td>
      <td><textarea name="Disablility" cols="50" rows="5"><?php echo $row_Recordset15['Disablility']; ?></textarea>      </td>
    </tr>
    <tr valign="baseline">
