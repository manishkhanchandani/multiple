...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
    <tr valign="baseline">
      <td nowrap align="right" valign="top"><span class="style1"><strong>Wishes:</strong></span></td>
      <td><textarea name="Wishes" cols="50" rows="5"></textarea>      </td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td nowrap align="right"><span class="style1"><strong>Email:</strong></span></td>
