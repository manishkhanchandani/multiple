...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO test2 (name, gender, age) VALUES (%s, %s, %s)",
  ...
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><select name="age">
        ...
        <option value="2" <?php if (!(strcmp(2, ""))) {echo "SELECTED";} ?>>26-35</option>
        <option value="3" <?php if (!(strcmp(3, ""))) {echo "SELECTED";} ?>>35+</option>
      </select>
      </td>
    </tr>
    <tr valign="baseline">
