  ...
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td valign="baseline"><table>
        <tr>
          <td><input type="radio" name="gender" value="Male" <?php if (!(strcmp($row_rsEdit['gender'],"Male"))) {echo "CHECKED";} ?>>
            Male</td>
        </tr>
        <tr>
          <td><input type="radio" name="gender" value="Female" <?php if (!(strcmp($row_rsEdit['gender'],"Female"))) {echo "CHECKED";} ?>>
            Female</td>
        </tr>
      </table></td>
    </tr>
    <tr valign="baseline">
      ...
      <td><select name="age">
        ...
        <option value="2" <?php if (!(strcmp(2, $row_rsEdit['age']))) {echo "SELECTED";} ?>>26-35</option>
        <option value="3" <?php if (!(strcmp(3, $row_rsEdit['age']))) {echo "SELECTED";} ?>>35+</option>
      </select>
      </td>
    </tr>
    <tr valign="baseline">
