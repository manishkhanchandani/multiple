...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
    ...
    <tr valign="baseline">
      <td nowrap align="right">AccountNo:</td>
    ...
    <tr valign="baseline">
      ...
      <td><textarea name="Description" cols="50" rows="5"><?php echo $row_Recordseditr['Description']; ?></textarea>
      </td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td nowrap align="right">Upload:</td>
