...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><textarea name="Identification" cols="50" rows="5"></textarea>
      </td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><textarea name="Allergy" cols="50" rows="5"></textarea>
      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right" valign="top">Disease:</td>
      <td><textarea name="Disease" cols="50" rows="5"></textarea>
      </td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right" valign="top">Disablility:</td>
      <td><textarea name="Disablility" cols="50" rows="5"></textarea>
      </td>
    </tr>
    <tr valign="baseline">
