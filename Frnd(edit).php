...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <h1 align="center" class="style2">EDIT FREIND LIST </h1>
  <p>&nbsp;</p>
  <table align="center">
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td nowrap align="right"><span class="style1">Category:</span></td>
    ...
    <tr valign="baseline">
      <td nowrap align="right"><span class="style1">EmailId:</span></td>
